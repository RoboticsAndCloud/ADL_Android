...
public class AudioRecorderAgent
...
//    }
    ...
    public AudioRecorderAgent setFilePath(String filePath) {
        this.filePath = filePath;
        return this;
    }

    public AudioRecorderAgent setColor(int color) {
        this.color = color;
        return this;
    }

//    public AudioRecorderAgent setRequestCode(int requestCode) {
//        this.requestCode = requestCode;
//        return this;
//    }

    public AudioRecorderAgent setSource(AudioSource source) {
        this.source = source;
        return this;
    }

    public AudioRecorderAgent setChannel(AudioChannel channel) {
        this.channel = channel;
        return this;
    }

    public AudioRecorderAgent setSampleRate(AudioSampleRate sampleRate) {
        this.sampleRate = sampleRate;
        return this;
    }

    public AudioRecorderAgent setAutoStart(boolean autoStart) {
        this.autoStart = autoStart;
        return this;
    }

    public AudioRecorderAgent setKeepDisplayOn(boolean keepDisplayOn) {
...
//                    new PullTransport.Default(Util.getMic(source, channel, sampleRate), AudioRecorderAgent.this),
//                    new File(filePath));
//        }
...
//    }
    ...
    public void resumeRecordingWithDuration() {
        isRecording = true;
//        saveMenuItem.setVisible(false);
//        statusView.setText(R.string.aar_recording);
//        statusView.setVisibility(View.VISIBLE);
...
//                @Override
//                public void run() {
//                    player.setOnCompletionListener(AudioRecorderAgent.this);
//                }
//            });
//
//            timerView.setText("00:00:00");
