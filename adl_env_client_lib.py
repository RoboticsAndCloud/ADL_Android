...
IPSEND = "192.168.0.105" # watch ip:192.168.0.116
...
if __name__ == "__main__":
    ...
    IPSEND = "192.168.0.105" # white box
    PORT = 59100 # wearable server
    ...
    while (True):
        ...
        if activeTime % 3 == 0: 
            ...
            time.sleep(3)
            cmd_mode_sending_handler(adl_type_constants.WMU_IPRECEIVE,adl_type_constants.WMU_RECEIVE_PORT,adl_type_constants.STATE_ENV_ACTIVITY_CMD_TAKING_IMAGE)
            time.sleep(3)
            cmd_mode_sending_handler(adl_type_constants.WMU_IPRECEIVE,adl_type_constants.WMU_RECEIVE_PORT,adl_type_constants.STATE_ENV_ACTIVITY_CMD_TAKING_AUDIO)
